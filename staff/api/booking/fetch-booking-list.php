<?php
    ...
    $sql = "SELECT
        ...
        WHERE b.status = 'Pending' AND departure_route.from_id = $terminal
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td>
                    <div class='table-data-feature'>
                        ...
                        <button type='button'
                            class='btn btn-light btn-cancel btn-rounded btn-fw'
                            data-bs-toggle='modal'
                            data-bs-target='#cancel-booking-modal'
                            data-book-id='{$row['booking_id']}'>Cancel</button>
                    </div>
                </td>";
            echo "</tr>";
            $count++;
