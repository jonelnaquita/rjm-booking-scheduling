                  ...
                  <div class="col-md">
                    <div class="form-group">
                      ...
                      <div class="probootstrap-date-wrap">
                        ...
                        <input type="text" id="date-departure" class="form-control" name="date-departure" placeholder="" required>
                      </div>
                    </div>
                  </div>
                  <div class="col-md">
                    <div class="form-group">
                      ...
                      <div class="probootstrap-date-wrap">
                        <span class="icon ion-calendar"></span> 
                        <input type="text" id="date-arrival" class="form-control" name="date-arrival" placeholder="" required>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <section class="container mt-4">
      <div class="row">
        ...
        <div class="col-md-4 d-flex align-items-start">
          <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#manage-booking">Manage My Bookings</button>
        </div>
      </div>
    </section>
