    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="font-weight-500 card-description">This shows the most booked bus type for each month, giving
                    insights into passenger preferences.</p>
                <canvas id="bus-chart" width="485" height="200"
                    style="display: block; box-sizing: border-box; height: 150px; width: 388px;"></canvas>
            </div>
        </div>
    </div>
</div>
