    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="font-weight-500 card-description">This shows the monthly income breakdown, providing a detailed view of the revenue generated each month.</p>
...
$(document).ready(function() {
    ...
    function loadRevenueData(year) {
        console.log('Loading revenue data for year:', year); // Debugging log
        $.ajax({
